...
if($registro["n_usuarios"]>0){
    ...
    $_SESSION['idarea']=$registro['idarea'];
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="templates/index2.html" class="h1"><b>MESA DE PARTES VIRTUAL</b></a>
            </div>
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <a href="index.php" class="text-md"><i class="fas fa-clipboard-check text-md"></i>
